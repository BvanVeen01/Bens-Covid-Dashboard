...
def parse_csv_data(csv_filename): # returns a list of strings for the rows in a csv file
...
def process_covid_csv_data(covid_csv_data): # this function returns three variables, as shown below.
